 ...
 */
JNIEXPORT jint JNICALL Java_compiler_jeandle_bytecodeTranslate_calls_TestManyArgs_checkargs(JNIEnv* env, jclass jclazz,
...
JNIEXPORT
void JNICALL Java_compiler_jeandle_bytecodeTranslate_calls_TestManyArgs_scramblestack(JNIEnv* env, jclass jclazz)
{
