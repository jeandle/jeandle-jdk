 ...
 *      -XX:+UseSerialGC -XX:MaxTenuringThreshold=2
 *      -XX:CompileCommand=compileonly,TestCardTableBarrier::test*
 *      -Xcomp -XX:-TieredCompilation -XX:+UseJeandleCompiler TestCardTableBarrier
 */
...
public class TestCardTableBarrier {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Trigger young GCs to promote the oldObject to the old generation.
        // Number of young should be greater than MaxTenuringThreshold.
        wb.youngGC();
        wb.youngGC();
        wb.youngGC();
