...
public class TestHashCode {
    ...
    static class TestWrapper {
        public static void main(String[] args) {
            ...
            if (enableIntrinsic) {
                // Force the fast path; it must still reject a non-interface receiver.
                Object preHashedInvalid = new Object();
                System.identityHashCode(preHashedInvalid);
                try {
                    TestHashCodeInterface.hash(forgeEmptyInterface(preHashedInvalid));
