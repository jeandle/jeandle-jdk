...
define hotspotcc i1 @jeandle.check_instanceof(ptr addrspace(0) nocapture %super_klass, ptr addrspace(1) nocapture %oop) noinline "lower-phase"="1" {
entry:
...
check_subtype:
  %is_subtype = call hotspotcc i1 @jeandle.check_instanceof(ptr addrspace(0) %super_klass, ptr addrspace(1) nocapture %oop)
...
check_subtype:
  ...
  %is_subtype = call hotspotcc i1 @jeandle.check_instanceof(ptr addrspace(0) %element_klass, ptr addrspace(1) nocapture %oop)
