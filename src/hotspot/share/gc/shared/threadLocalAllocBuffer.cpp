...
void ThreadLocalAllocBuffer::startup_initialization() {
  ...
  bool allocation_prefetch_supported = CompilerConfig::is_c2_or_jvmci_compiler_enabled();
#ifdef JEANDLE
  allocation_prefetch_supported |= UseJeandleCompiler;
#endif
  if (allocation_prefetch_supported) {
